...
const citiesAtoJ = (arr) => {
  ...
  for(let i =0;i<arr.length ;i++){
    if(arr[i].match(reg)) newArray.push(arr[i]);
  }
...
xdescribe('Testing challenge 9', () => {
  let startString = 'This is a reg challenge. We are trying to create a hangman phrase where all of the vowels are missing!';
