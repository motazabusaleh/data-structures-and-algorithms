...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
Write a function name wordsToCharList that, given a string as input, returns a new array where every ele is a character of the input string.
...
Write a function named extractVowels that takes in a string and returns an array where the first ele is the original string with all the vowels removed, and the second ele is a string of all the vowels that were removed, in alphabetical order.
